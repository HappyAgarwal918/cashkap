(function($) {		
	...
	var addStylePanel = '<div class="stylepanel-on-right"> <div class="switcher-btn-bx"> <a class="switch-btn closed"> <span class="fa fa-cog"></span> </a> </div><div class="styleswitcher-inner"> <h6 class="switcher-title">Color Skin</h6> <ul class="color-skins"> <li><a data-menu-logo="images/logo.png" data-pt-logo="images/logo-white.png" data-header-transparent-logo="images/logo-white.png" class="theme-skin skin-1" href="css/color/color-1.css" title="Purple"></a></li><li><a data-menu-logo="images/logo-2.png" data-pt-logo="images/logo-white-2.png" data-header-transparent-logo="images/logo-white-2.png" class="theme-skin skin-2" href="css/color/color-2.css" title="Orange"></a></li><li><a data-menu-logo="images/logo-3.png" data-pt-logo="images/logo-white-3.png" data-header-transparent-logo="images/logo-white-3.png" class="theme-skin skin-3" href="css/color/color-3.css" title="Blue"></a></li><li><a data-menu-logo="images/logo-4.png" data-pt-logo="images/logo-white-4.png" data-header-transparent-logo="images/logo-white-4.png" class="theme-skin skin-4" href="css/color/color-4.css" title="Red"></a></li></ul> </div></div>';
