    ...
    <div id="content">
      ...
      <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between">
          <h1 class="h3 mb-0 text-gray-800 mb-2">Edit City</h1>
        </div>
        <div class="row">
		...
		echo form_open_multipart("master/setting/edit-city/$segment4/$segment5",$attributes);
		?>
              <div class="col-md-12">
                <div class="row">
                  <div class="col-md-12">
				...
				'type'  => 'text',
				'class' => "form-control",
				'value' =>set_value('city_name',$citydata->city_name)));
				?> 
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select name="city_status" class="form-control">
                        <option value="1"  <?php echo set_select('city_status',1,$citydata->city_status==1); ?>>Active</option>
                        <option value="0"  <?php echo set_select('city_status',0,$citydata->city_status==0); ?>>Inactive</option>
                      </select>
                ...
                <div class="row">
                  <div class="form-group col-md-6 col-sm-12 col-xs-12 mtop20">
                    <button name="addCity" class="btn btn-primary" type="submit">Submit</button>
                  </div>
                </div>
              </div>
