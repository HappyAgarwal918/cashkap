    ...
    <div id="content">
      ...
      <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between">
          <h1 class="h3 mb-0 text-gray-800 mb-2">Manage Associates: Pending </h1>
        </div>
                  ...
                  <div class="table-responsive​">
                    <table class="table table-bordered table-responsive​" id="dataTable" width="100%" cellspacing="0">
                      <thead>
                        <tr>
                          ...
                          <th width="26%" valign="top" class="column-title">College/University/Institute</th>
                          <th width="18%" valign="top" class="column-title">Category</th>
                          <th width="19%" valign="top" class="column-title">Contact Person</th>
					...
					?>
                        <tr class="even pointer">
                          ...
                          <td><?php if($assocrow->assoc_status==1){ echo "Active";}else{ echo "Inactive";} ?></td>
                          ...
                          <td width="5%" align="center"><a href="<?php echo site_url("master/associate/view/$assoc_id"); ?>"  title="Edit"><i class="fa fa-eye"></i> </a></td>
                        </tr>
                        <?php }  ?>
                      </tbody>
                    </table>
