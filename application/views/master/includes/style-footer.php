...
<script src="<?php echo base_url(); ?>assets/master/vendor/chart.js/Chart.min.js"></script> 
<script src="<?php echo base_url(); ?>assets/master/js/demo/chart-area-demo.js"></script> 
<script src="<?php echo base_url(); ?>assets/master/js/demo/chart-pie-demo.js"></script>