    ...
    <div id="content">
      ...
      <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between">
          <h1 class="h3 mb-0 text-gray-800 mb-2">Manage Courses</h1>
          </div>
              ...
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                <thead>
                  <tr>
                    ...
                    <th width="25%">Submenu</th>
                    <th width="12%">Status</th>
                    <th width="7%" valign="top" class="column-title">Edit</th>
                  </tr>
                </thead>
                <tbody>
                  <?php 
				$count=0;
                  ...
                  <tr class="even pointer">
                    ...
                    <td><?php echo $courserow->assoccat_title; ?></td>
                    <td><?php $course_status=$courserow->course_status; if($course_status==1){ echo "Active"; }else{ echo "Inactive"; } ?></td>
                    <td><a href="<?php echo site_url("master/course/edit/$course_id"); ?>" class="">Edit</a></td>
                  </tr>
                  <?php }  ?>
                </tbody>
              </table>
