...
<li class="breadcrumb-item active" aria-current="page">Edit Video</li>
		...
		echo form_open_multipart("master/video-gallery/edit/$segment4",$attributes);
 			 ?>
              <div class="col-md-12">
                <div class="row">
				...
				'type'  => 'text',
				'class' => "form-control",
				'value' =>set_value('video_title',$videodata->video_title)));
				...
				'rows'  => 3,
				'class' => "form-control",
				'value' =>set_value('video_code',$videodata->video_code,false)));
...
<option value="1" <?php echo set_select('video_status',1,$videodata->video_status==1); ?>>Active</option>
<option value="0" <?php echo set_select('video_status',0,$videodata->video_status==0); ?>>Inactive</option>
				 </select>
<?php echo form_error('video_status'); ?>
				...
				'type'  => 'text',
				'class' => "form-control",
				'value' =>set_value('video_disorder',$videodata->video_disorder)));
