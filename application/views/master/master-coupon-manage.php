              ...
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
				...
				$count=0;
                  ...
                  <tr class="even pointer">
                    ...
                    <td><?php $slip=$disrow->stuco_redeemslip; if($slip!=""){ ?>
						<a href="<?php echo base_url().$slip; ?>" target="_blank">View</a>
						<?php } ?></td>
                        <td><?php if($disrow->stuco_cashbackpaid==1){ echo "Yes"; }else{ echo "No"; } ?></td>
                     <td><?php $stuco_redeemdate=$disrow->stuco_redeemdate;
                    ...
                    <td><a href="<?php echo site_url("master/coupon/view/$stuco_id"); ?>" class="">View</a></td>
                  </tr>
                  <?php }  ?>
                </tbody>
              </table>
