    ...
    <div id="content">
      ...
      <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between">
          <h1 class="h3 mb-0 text-gray-800 mb-2">Manage Cities: <?php echo $statedata->state_name; ?></h1>
        ...
        <div class="row">
        	<div class="col-md-12">
                 <p><a href="<?php echo site_url("master/setting/add-city/$segment4"); ?>">+ Add New</a></p>
            </div>
        </div>
        <div class="row">
          <div class="col-xl-12 col-md-12 mb-4">
            <div class="inner-section">
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                <thead>
                  <tr>
                    <th width="11%" valign="top" class="column-title">Sr.</th>
                    <th width="65%">City Name</th>
                    <th width="16%">Status</th>
                    <th width="8%" valign="top" class="column-title">Edit</th>
                  </tr>
                </thead>
                <tbody>
                  <?php 
				$count=0;
                  ...
                  <tr class="even pointer">
                    ...
                    <td><?php $city_status=$cityrow->city_status; if($city_status==1){ echo "Active"; }else{ echo "Inactive"; } ?></td>
                    <td><a href="<?php echo site_url("master/setting/edit-city/$segment4/$city_id"); ?>" class="">Edit</a></td>
                  </tr>
                  <?php }  ?>
                </tbody>
              </table>
