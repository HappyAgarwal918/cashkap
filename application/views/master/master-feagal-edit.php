    ...
    <div id="content">
      ...
      <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between">
          <h1 class="h3 mb-0 text-gray-800 mb-2">Edit Photo</h1>
        </div>
        ...
        <div class="row">
          ...
          <?php $attributes = array('class' => 'tender-form form-horizontal','method'=>'post','autocomplete'=>'off');   	echo form_open_multipart("master/featured-gallery/edit/$segment4",$attributes);
              ...
              <div class="col-md-12">
				...
				'type'  => 'text',
				'class' => "form-control",
				'value' =>set_value('feagal_title',$feaimgdata->feagal_title)));
				...
				'type'  => 'text',
				'class' => "form-control",
				'value' =>set_value('feagal_disorder',$feaimgdata->feagal_disorder)));
				?> <?php echo form_error('feagal_disorder'); ?> </div>
                
                  <div class="form-group col-md-6 col-sm-6 col-xs-12">
                    <label>Thumbnail <span class="note">
                    <?php if($feaimgdata->feagal_thumb!=""){ ?> <a href="<?php echo base_url().$feaimgdata->feagal_thumb; ?>" target="_blank">Old File</a>  <?php } ?>
                    </span></label>
                    <?php echo form_input(array(
				'name'  => 'feagal_thumb',
				'id'    => 'feagal_thumb',
