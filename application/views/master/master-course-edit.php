      ...
      <div class="container-fluid">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo site_url("master/course/manage");  ?>">Manage Course</a></li>
          ...
          <div class="col-xl-12 col-md-12 mb-4">
            <div class="inner-section">
              ...
              <?php 
				...
				echo form_open_multipart("master/course/edit/$segment4",$attributes);
 			 ?>
              <div class="col-md-12">
              <div class="row">
              <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <?php  foreach($cocatdata as $cocatrow){ ?>
                        <option value="<?php echo $cocatrow->course_id; ?>"  <?php echo set_select('course_eduparent',$cocatrow->course_id,$coursedata->course_eduparent==$cocatrow->course_id); ?>><?php echo $cocatrow->course_name; ?></option>
                       <?php } ?> 
                      </select>
             ...
             <div class="form-group col-md-6 col-sm-12 col-xs-12">
				...
				'type'  => 'text',
				'class' => "form-control",
				'value' =>set_value('course_name',$coursedata->course_name)));
				...
				'type'  => 'text',
				'class' => "form-control",
				'value' =>set_value('course_slug',$coursedata->course_slug)));
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <select name="course_status" class="form-control">
                        <option value="1"  <?php echo set_select('course_status',1,$coursedata->course_status==1); ?>>Active</option>
                         <option value="0"  <?php echo set_select('course_status',0,$coursedata->course_status==0); ?>>Inactive</option>
                      </select>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select name="course_catsubmenu" class="form-control">
                      	<option value="0"  <?php echo set_select('course_catsubmenu',0,$coursedata->course_catsubmenu==0); ?>>No</option>
                        <option value="4"  <?php echo set_select('course_catsubmenu',4,$coursedata->course_catsubmenu==4); ?>>Yes</option>
                      </select>
				...
				'type'  => 'text',
				'class' => "form-control",
				'value' =>set_value('course_disorder',$coursedata->course_disorder)));
