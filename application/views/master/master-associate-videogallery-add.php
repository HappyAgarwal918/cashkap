    ...
    <div id="content">
      ...
      <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between">
          <h1 class="h3 mb-0 text-gray-800 mb-2">Add Video</h1>
        </div>
...
echo form_open_multipart("master/associate/add-video/$segment4",$attributes);
            ...
            'type'=>'text',
            'class'=> "form-control",
            'value'=>set_value('assocvg_videolink')));
