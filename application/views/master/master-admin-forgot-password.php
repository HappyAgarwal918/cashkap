    ...
    <div class="col-xl-6 col-lg-12 col-md-6">
            ...
            <div class="col-lg-12">
             ...
             <?php 
			 	$attributes = array('class'=> 'user','method'=>'post','autocomplete'=>'off','id'=>'formLogin');  
          		echo form_open('master/forgot-password',$attributes);
				?>
                <div class="row">
                <div class="col-md-12">
                <div class="form-group"> 
				<label>Enter Registered Email Id <span class="req">*</span></label>
				<?php echo form_input(array('name'=>'adm_email','id'=>'adm_email','class'=>'form-control form-control-user','value'=>set_value('adm_email'),'maxlength'=>'100')); ?> <?php echo form_error('adm_email'); ?> </div>
                </div>
                </div>
               <div class="row">
                	<div class="col-md-12">
     ...
     <p>Submit</p>
               ...
               <?php form_close(); ?>
                ...
                <hr>
                <div class="text-center"><a class="small" href="<?php echo site_url("master/login"); ?>" title="Forgot Password">Back to Admin Login?</a> </div>
              </div>
            </div>
          </div>
        </div>
