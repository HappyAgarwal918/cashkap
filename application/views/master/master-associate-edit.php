...
<div id="wrapper">
  ...
  <div id="content-wrapper" class="d-flex flex-column">
    ...
    echo form_open("master/associate/edit/$segment4",$attributes);
    ...
    ?>
                ...
                <div class="form-group col-md-6 col-sm-12 col-xs-12">
                      ...
                      <label>Google Rank <span class="req">*</span></label>
            ...
            <label class="checklabel"><?php  echo form_checkbox('assoc_facility[]',$facilityrow->facilitity_title,set_checkbox('assoc_facility[]',$facilityrow->facilitity_title,in_array($facilityrow->facilitity_title,$assoc_facar))); ?> <?php echo $facilityrow->facilitity_title; ?></label>
                ...
                ?> <?php echo form_error('assoc_email'); ?> </div>
                   ...
                   <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-head">About  College/University/Institute/School </div>
                  ...
                  <div class="row">
                    ...
                    ?> 
                       ...
                       <?php echo form_error('associate_about'); ?> </div>
    
                    </div>
                  
    			 <div class="row">
    				<div class="col-md-12">
    					<div class="form-head">Social Pages </div>
    					</div>
                ...
                ?> <?php echo form_error('assoc_social_facebook'); ?> </div>
                  </div>
                  <div class="row">
                  	<div class="form-group col-md-12 col-sm-12 col-xs-12">
                ...
                ?> <?php echo form_error('assoc_social_instagram'); ?> </div>
                  </div>
                ...
                ?> <?php echo form_error('assoc_social_twitter'); ?> </div>
                  </div>
                ...
                ?> <?php echo form_error('assoc_social_website'); ?> </div>
                  </div>
          ...
          <label>Create Username <span class="note">(Min. 6-20 character)</span> <span class="req">*</span></label>
                ...
                'value'=>set_value('assoc_username',$assocdata->assoc_username)));
    
                ?> <?php echo form_error('assoc_username'); ?> </div>
    
                <div class="form-group col-md-6 col-sm-12 col-xs-12">
    
                      <label>Create Password  <span class="note">(Leave blank if same as old)</span> </label>
