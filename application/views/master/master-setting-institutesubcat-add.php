...
Manage Institute Categories
            ...
            <li class="breadcrumb-item active" aria-current="page">Add Institute Category</li>
          </ol>
        </nav>
        <div class="d-sm-flex align-items-center justify-content-between">
          <h1 class="h3 mb-0 text-gray-800 mb-2">Add Institute Category</h1>
        </div>
        <div class="row">
		...
		echo form_open_multipart("master/setting/add-institute",$attributes);
              ...
              <div class="col-md-12">
				...
				'type'  => 'text',
				'class' => "form-control",
				'value' =>set_value('assoccat_title')));
				?> 
				...
				'type'  => 'text',
				'class' => "form-control",
				'value' =>set_value('assoccat_disorder')));
				?> 
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select name="assoccat_status" class="form-control">
                        <option value="1"  <?php echo set_select('assoccat_status',1); ?>>Active</option>
                        <option value="0"  <?php echo set_select('assoccat_status',0); ?>>Inactive</option>
                      </select>
