...
echo form_open_multipart("associate/edit-gallery/$segment3",$attributes);
			?>
            ...
            'type'=>'text',
            'class'=> "form-control",
            'value'=>set_value('assocph_title',$photodata->assocph_title)));
            ?> <?php echo form_error('assocph_title'); ?> </div>
            <div class="form-group col-md-6 col-sm-6 col-xs-12">
            <?php  $assocph_photo=$photodata->assocph_photo; ?>
                    <label>Attach Photo <?php if($assocph_photo!=""){?><a href="<?php echo base_url().$assocph_photo; ?>" style="text-decoration:underline;">Old File</a>  <?php } ?><span class="note">(800*600px)</span></label>
                    <?php 
