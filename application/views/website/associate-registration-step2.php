...
echo form_hidden('assoc_category',$maincatdata->assoccat_id);
            ...
            <div class="form-group col-md-4 col-sm-12 col-xs-12">
                  ...
                  <label>Last Session Result Percentage </label>
            ...
            ?> <?php echo form_error('assoc_instconame'); ?> </div>	 
                ...
                <div class="form-group col-md-6 col-sm-12 col-xs-12">
                    ...
                    <label>Boarding School <span class="req">*</span></label>
                    <select class="form-control assoc_boarding_type" name="assoc_boarding_type">
                    <option value="">--Select--</option>
