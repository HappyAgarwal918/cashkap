    ...
    <div class="page-banner ovbl-dark" style="background-image:url(assets/images/banner/banner2.jpg);">
      <div class="container">
        <div class="page-banner-entry">
          <h1 class="text-white">Associate Forgot Password</h1>
        </div>
      </div>
    </div>
    <div class="breadcrumb-row">
      <div class="container">
        <ul class="list-inline">
          ...
          <li>Associate Forgot Password</li>
        </ul>
      </div>
    </div>
...
echo form_open("associate/forgot-password",$attributes);
?>
 ...
 <p><a  href="<?php echo site_url("associate/login"); ?>" class="">&raquo; Back to Login</a></p> </div>
                </div>
                <?php form_close(); ?>
              </div>
            </div>
