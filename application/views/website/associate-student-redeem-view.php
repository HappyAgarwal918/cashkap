  ...
  <div class="container-fluid">
    <div class="db-breadcrumb">
      ...
      <ul class="db-breadcrumb-list">
        ...
        <li><a href="<?php echo site_url("associate/student-redeemed/manage"); ?>">Student- Redeemed</a></li>
      ...
      <div class="col-md-12">
        <table  style="width:100%" class="table table-bordered table-striped">
          ...
          <tr>
           ...
           <tr>
            <td>Amount</td>
            <td>Rs. <?php echo $studata->stuco_redeemamount; ?></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td><?php $stuco_redeemslipdatetime=$studata->stuco_redeemslipdatetime;
					if($stuco_redeemslipdatetime!="" && $stuco_redeemslipdatetime!="0000-00-00"){
						echo date('d-m-Y',strtotime($stuco_redeemslipdatetime));
					}
			 ?> </td>
          </tr>
          <tr>
