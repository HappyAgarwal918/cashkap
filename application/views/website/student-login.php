  ...
  <div class="page-content"> 
    ...
    <div class="content-block"> 
      ...
      <div class="section-area section-sp1">
        <div class="container">
        <div class="row">
                  <div class="col-md-12 text-center my-4"> <a  href="<?php echo site_url("student/registration"); ?>" class="btn signup">New Student Register Here</a> </div>
                </div>
          <div class="row">
            ...
            ?> <?php echo form_error('stureg_password'); ?> </div>
                ...
                <div class="row">
                  <div class="col-md-3 col-sm-12 col-xs-12">
                    <button class="btn btn-primary btn-custom-create" type="submit" name="sublogin">Login Now</button>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-12">
                    <p class="forgotpass">If you <a  href="<?php echo site_url("student/forgot-password"); ?>" class="forgot">forget your password</a>, you can request to retrieve your password ?</a></p>
                  </div>
                </div>
