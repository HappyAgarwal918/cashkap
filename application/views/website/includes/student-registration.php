...
<body id="bg">
                ...
                <div class="bg-gray padbox boxborder">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-md-6 col-sm-12 col-xs-12">
                      ...
                      <select class="form-control stureg_course" name="stureg_course">
                        <option value="">--Select--</option>
                        <?php foreach ($coursedata as $courserow) {

                          if (!empty($courserow->subs)) { ?>
                            <optgroup label="<?php echo $courserow->course_name; ?>">
                              <?php foreach ($courserow->subs as $coursesubrow) { ?>
                                <option value="<?php echo $coursesubrow->course_id; ?>" <?php echo set_select('stureg_course', $coursesubrow->course_id, $coursesubrow->course_id == $sescourse); ?>><?php echo $coursesubrow->course_name; ?></option>
                              <?php } ?>
                            </optgroup>
                          <?php } ?>
                        <?php } ?>
                      </select>
                      <?php echo form_error('stureg_course'); ?>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12">
                  ...
                  <div class="row">
                    <div class="form-group col-md-12 col-sm-12 col-xs-12">
                      ...
                      ?> <?php echo form_error('stureg_address_line1'); ?>
                    </div>
                  ...
                  <div class="row">
                    <div class="form-group col-md-6 col-sm-12 col-xs-12">
                      ...
                      <?php echo form_error('stureg_address_country'); ?>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-md-6 col-sm-12 col-xs-12">
                      ...
                      ?> <?php echo form_error('stureg_address_pin'); ?>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12">
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      toggleFields();
      $(".stureg_address_country").change(function() {
        toggleFields();
      });
    });
