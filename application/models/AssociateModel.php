<?php class AssociateModel extends CI_Model
{
	...
	public function getPerAssocPerPhoto($assocsesid, $assocph_id)
	{
		$this->db->from('tb_assocgallery');
		$this->db->where('assocph_associd', $assocsesid);
		$this->db->where('assocph_id', $assocph_id);
		$query = $this->db->get();
		return $query->row();
	}

	public function insAssociate($data, $assoc_category)
	{
		$assoc_regdate = date("y-m-d");
		if ($assoc_category == 1 || $assoc_category == 2) {
			$dataInsert = array('assoc_category' => $assoc_category, 'assoc_subcat' => $data['assoc_subcat'], 'assoc_instconame' => $data['assoc_instconame'], 'assoc_totalarea' => $data['assoc_totalarea'], 'assoc_consarea' => $data['assoc_consarea'], 'assoc_affibody' => $data['assoc_affibody'], 'assoc_edurank' => $data['assoc_edurank'], 'assoc_noteacher_graduate' => $data['assoc_noteacher_graduate'], 'assoc_noteacher_masters' => $data['assoc_noteacher_masters'], 'assoc_noteacher_phd' => $data['assoc_noteacher_phd'], 'assoc_lastses_nostudent' => $data['assoc_lastses_nostudent'], 'assoc_lastses_placement' => $data['assoc_lastses_placement'], 'assoc_placement_loc' => $data['assoc_placement_loc'], 'assoc_achievements' => $data['assoc_achievements'], 'assoc_cocuriactivity' => $data['assoc_cocuriactivity'], 'assoc_amenities' => $data['assoc_amenities'], 'assoc_facility' => $data['assoc_facility'], 'assoc_address_line1' => $data['assoc_address_line1'], 'assoc_address_line2' => $data['assoc_address_line2'], 'assoc_address_city' => $data['assoc_address_city'], 'assoc_address_state' => $data['assoc_address_state'], 'assoc_address_country' => $data['assoc_address_country'], 'assoc_address_pin' => $data['assoc_address_pin'], 'assoc_address_landmark' => $data['assoc_address_landmark'], 'assoc_contactno' => $data['assoc_contactno'], 'assoc_email' => $data['assoc_email'], 'assoc_contactname' => $data['assoc_contactname'], 'assoc_designation' => $data['assoc_designation'], 'assoc_username' => $data['assoc_username'], 'assoc_password' => md5($data['assoc_password']), 'assoc_regdate' => $assoc_regdate, 'assoc_lastsesresult' => $data['assoc_lastsesresult'], 'assoc_noteacher' => $data['assoc_noteacher']);
		} elseif ($assoc_category == 3) {
			$dataInsert = array('assoc_category' => $assoc_category, 'assoc_subcat' => $data['assoc_subcat'], 'assoc_instconame' => $data['assoc_instconame'], 'assoc_boarding_type' => $data['assoc_boarding_type'], 'assoc_consarea' => $data['assoc_consarea'], 'assoc_affibody' => $data['assoc_affibody'], 'assoc_edurank' => $data['assoc_edurank'], 'assoc_noteacher' => $data['assoc_noteacher'], 'assoc_lastsesresult' => $data['assoc_lastsesresult'], 'assoc_lastsesnostudent' => $data['assoc_lastsesnostudent'], 'assoc_achievements' => $data['assoc_achievements'], 'assoc_cocuriactivity' => $data['assoc_cocuriactivity'], 'assoc_facility' => $data['assoc_facility'], 'assoc_address_line1' => $data['assoc_address_line1'], 'assoc_address_line2' => $data['assoc_address_line2'], 'assoc_address_city' => $data['assoc_address_city'], 'assoc_address_state' => $data['assoc_address_state'], 'assoc_address_country' => $data['assoc_address_country'], 'assoc_address_pin' => $data['assoc_address_pin'], 'assoc_address_landmark' => $data['assoc_address_landmark'], 'assoc_contactno' => $data['assoc_contactno'], 'assoc_email' => $data['assoc_email'], 'assoc_contactname' => $data['assoc_contactname'], 'assoc_designation' => $data['assoc_designation'], 'assoc_username' => $data['assoc_username'], 'assoc_password' => md5($data['assoc_password']), 'assoc_regdate' => $assoc_regdate);
		} elseif ($assoc_category == 4) {
			if ($data['assoc_subcat'] != 8) {
				$dataInsert = array('assoc_category' => $assoc_category, 'assoc_subcat' => $data['assoc_subcat'], 'assoc_establishyear' => $data['assoc_establishyear'], 'assoc_instconame' => $data['assoc_instconame'], 'assoc_consarea' => $data['assoc_consarea'], 'assoc_noteacher' => $data['assoc_noteacher'], 'assoc_lastsesresult' => $data['assoc_lastsesresult'], 'assoc_facility' => $data['assoc_facility'], 'assoc_address_line1' => $data['assoc_address_line1'], 'assoc_address_line2' => $data['assoc_address_line2'], 'assoc_address_city' => $data['assoc_address_city'], 'assoc_address_state' => $data['assoc_address_state'], 'assoc_address_country' => $data['assoc_address_country'], 'assoc_address_pin' => $data['assoc_address_pin'], 'assoc_address_landmark' => $data['assoc_address_landmark'], 'assoc_contactno' => $data['assoc_contactno'], 'assoc_email' => $data['assoc_email'], 'assoc_contactname' => $data['assoc_contactname'], 'assoc_designation' => $data['assoc_designation'], 'assoc_username' => $data['assoc_username'], 'assoc_password' => md5($data['assoc_password']), 'assoc_regdate' => $assoc_regdate, 'assoc_classmode' => $data['assoc_classmode'], 'assoc_stustrength' => $data['assoc_stustrength'], 'assoc_googlerate' => $data['assoc_googlerate']);
			} else {
				$dataInsert = array('assoc_category' => $assoc_category, 'assoc_subcat' => $data['assoc_subcat'], 'assoc_establishyear' => $data['assoc_establishyear'], 'assoc_instconame' => $data['assoc_instconame'], 'assoc_consarea' => $data['assoc_consarea'], 'assoc_noteacher' => $data['assoc_noteacher'], 'assoc_lastsesresult' => $data['assoc_lastsesresult'], 'assoc_facility' => $data['assoc_facility'], 'assoc_address_line1' => $data['assoc_address_line1'], 'assoc_address_line2' => $data['assoc_address_line2'], 'assoc_address_city' => $data['assoc_address_city'], 'assoc_address_state' => $data['assoc_address_state'], 'assoc_address_country' => $data['assoc_address_country'], 'assoc_address_pin' => $data['assoc_address_pin'], 'assoc_address_landmark' => $data['assoc_address_landmark'], 'assoc_contactno' => $data['assoc_contactno'], 'assoc_email' => $data['assoc_email'], 'assoc_contactname' => $data['assoc_contactname'], 'assoc_designation' => $data['assoc_designation'], 'assoc_username' => $data['assoc_username'], 'assoc_password' => md5($data['assoc_password']), 'assoc_regdate' => $assoc_regdate, 'assoc_classmode' => $data['assoc_classmode'], 'assoc_stustrength' => $data['assoc_stustrength'], 'assoc_classmode' => $data['assoc_classmode'], 'assoc_stustrength' => $data['assoc_stustrength'], 'assoc_googlerate' => $data['assoc_googlerate'], 'assoc_bestscorelastses' => $data['assoc_bestscorelastses'], 'assoc_staffscore56' => $data['assoc_staffscore56'], 'assoc_staffscore67' => $data['assoc_staffscore67'], 'assoc_staffscore78' => $data['assoc_staffscore78'], 'assoc_staffquali_twe' => $data['assoc_staffquali_twe'], 'assoc_staffquali_diploma' => $data['assoc_staffquali_diploma'], 'assoc_noteacher_graduate' => $data['assoc_staffquali_graduation'], 'assoc_noteacher_masters' => $data['assoc_staffquali_masters'], 'assoc_noteacher_phd' => $data['assoc_staffquali_phd']);
			}
		} elseif ($assoc_category == 5) {
			$dataInsert = array('assoc_category' => $assoc_category, 'assoc_subcat' => $data['assoc_subcat'], 'assoc_instconame' => $data['assoc_instconame'], 'assoc_noteacher' => $data['assoc_noteacher'], 'assoc_facility' => $data['assoc_facility'], 'assoc_address_line1' => $data['assoc_address_line1'], 'assoc_address_line2' => $data['assoc_address_line2'], 'assoc_address_city' => $data['assoc_address_city'], 'assoc_address_state' => $data['assoc_address_state'], 'assoc_address_country' => $data['assoc_address_country'], 'assoc_address_pin' => $data['assoc_address_pin'], 'assoc_address_landmark' => $data['assoc_address_landmark'], 'assoc_contactno' => $data['assoc_contactno'], 'assoc_email' => $data['assoc_email'], 'assoc_contactname' => $data['assoc_contactname'], 'assoc_designation' => $data['assoc_designation'], 'assoc_username' => $data['assoc_username'], 'assoc_password' => md5($data['assoc_password']), 'assoc_regdate' => $assoc_regdate);
		}

		$this->db->insert('tb_associate', $dataInsert);
		return  $this->db->insert_id();
	}
	public function assocLoginCheck($data)
	{
		$assoc_username = $data['assoc_username'];
		$assoc_password = md5($data['assoc_password']);
		$this->db->where('assoc_username', $assoc_username);
		$this->db->where('assoc_password', $assoc_password);
		$this->db->where('assoc_status !=', 2);
		$query = $this->db->get('tb_associate');
		if ($query->num_rows() > 0) {
			$row = $query->row();
			return $query->row();
		} else {
	...
	public function getAssocByEmailCount($assoc_email)
	{
		$this->db->from('tb_associate');
		$this->db->where('assoc_email', $assoc_email);
		$query = $this->db->get();
	...
	public function getAssociateByEmail($assoc_email)
	{
		$this->db->from('tb_associate');
		$this->db->where('assoc_email', $assoc_email);
		$query = $this->db->get();
	...
	public function updateForgotPassword($assoc_id, $new_password)
	{
		$dataUpdate = array('assoc_password' => md5($new_password));
		$this->db->where('assoc_id', $assoc_id);
		return $this->db->update('tb_associate', $dataUpdate);
	}
	public function upAssocGalleryPhoto($data, $assocsesid, $assocph_id, $photo_final)
	{
		$dataUpdate = array('assocph_title' => $data['assocph_title'], 'assocph_photo' => $photo_final);
		$this->db->where('assocph_associd', $assocsesid);
		$this->db->where('assocph_id', $assocph_id);
		return $this->db->update('tb_assocgallery', $dataUpdate);
	}
	...
	public function upAssociateAbout($data, $assocsesid)
	{
		$dataUpdate = array('associate_about' => $data['associate_about']);
		$this->db->where('assoc_id', $assocsesid);
		return $this->db->update('tb_associate', $dataUpdate);
	}
	...
	public function addAssocGalleryPhoto($data, $assocsesid, $photo_final)
	{
		...
		$this->db->insert('tb_assocgallery', $dataInsert);
		return  $this->db->insert_id();
	}
	public function setOtherNonFeatured($insphoto, $assocsesid)
	{
		$dataUpdate = array('assocph_featured' => 0);
		$this->db->where('assocph_associd', $assocsesid);
		$this->db->where('assocph_id !=', $insphoto);
		return $this->db->update('tb_assocgallery', $dataUpdate);
	}
	public function upAssocFeaturedImg($assocsesid, $photo_final)
	{
	...
	/****** Associate Students ********/
	public function getAllStudentPend($assoc_id)
	{
		$this->db->from('tb_studisform');
		$this->db->where('stuco_associd', $assoc_id);
	...
	public function getAllStudentApproved($assoc_id)
	{
		$this->db->from('tb_studisform');
		$this->db->where('stuco_associd', $assoc_id);
		$this->db->where('stuco_otpverstatus', 1);
	...
	public function getPerStudent($stuco_id)
	{
		$this->db->from('tb_studisform');
	...
	public function upRedeemCouponStatus($data, $stuco_id)
	{
		$stuco_redeemdate = date("Y-m-d");
		$dataUpdate = array('stuco_redeemamount' => $data['stuco_redeemamount'], 'stuco_redeemstatus' => 1, 'stuco_redeemdate' => $stuco_redeemdate);
		$this->db->where('stuco_id', $stuco_id);
